...
import com.cd.dnf.credit.view.DeleteEditText;
...
public class RegisterActivity extends CreditSwipBackActivity implements KaptchaInterface {
    ...
    DeleteEditText mPhoneNumberView;
    ...
    private void registerServer() {
        ...
        String verifyCodeStr = mVerifyCodeView.getText().toString().trim();//图片码
        ...
        OkGo.<String>post(CreditApi.API_REGISTER).upJson(jsonStr).tag("register").execute(
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ...
                        if(mFirebaseAnalytics!=null){
                            mFirebaseAnalytics.logEvent(AnalyticUtil.REGISTER_CLICK,null);
                        }
                    }
                });
    }
    @OnClick(value = {R.id.back_layout, R.id.btn_pic_code, R.id.show_pwd, R.id.see_agree_view})
    ...
    private void fetchPictureCode(boolean showDilaog) {
        ...
        OkGo.<String>get(CreditApi.API_FETCH_PICTURE_CODE).params(params).tag("picCode").execute(
    ...
    protected void onDestroy() {
        ...
        OkGo.getInstance().cancelTag("picCode");
        OkGo.getInstance().cancelTag("smsCode");
    }
