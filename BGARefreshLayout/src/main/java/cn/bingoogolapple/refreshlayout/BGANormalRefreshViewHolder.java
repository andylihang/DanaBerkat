...
public class BGANormalRefreshViewHolder extends BGARefreshViewHolder {
    ...
    public BGANormalRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        ...
        mRefreshingText=context.getResources().getString(R.string.bga_refresh_loading_str);
        mReleaseRefreshText=context.getResources().getString(R.string.bga_refresh_release_str);
        mPullDownRefreshText=context.getResources().getString(R.string.bga_refresh_pull_str);
        initAnimation();
    }
